...
class StartButton extends React.Component {
  ...
  render() {
    return (
      <div style={{ marginRight:10, marginLeft: 500 }}>
        <button className="btn btn-primary btn-lg" onClick={this.props.startCountDown}>Start</button>
      </div>
    );
  }
}
...
class StopButton extends React.Component {
  render() {
    return (
      <div style={{ marginRight: 10, marginLeft: 500, marginTop:50 }}>
        <button className="btn btn-primary btn-lg" onClick={this.props.stopCountDown}>Stop</button>
      </div>
    );
  }
}
...
class Pomodoro extends React.Component {
  ...
  render() {
    ...
    return (
      <div >
        <div class="row" style={{ paddingTop: 100, paddingLeft: 200 }}>
          <div></div>
        ...
        <div class="row">&nbsp;</div>
        <div class="row" style={{ paddingLeft: 150  }}>
          <div class="col-md-4"></div>

          <StopButton stopCountDown={this.stopCountDown} />
          </div>
          <div class="row" style={{ paddingTop: 10,paddingLeft: 150, paddingBlockEnd:150 }}>
